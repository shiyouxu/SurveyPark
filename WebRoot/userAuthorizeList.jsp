			...
			<table>
				...
				<s:iterator value="allUsers" status="st">
					...
					<tr>
						...
						<td><s:a action="UserAuthorizeAction_editAuthorize?userId=%{#userId}" cssClass="aList">修改</s:a></td>
						<td><s:a action="UserAuthorizeAction_clearAuthorize?userId=%{#userId}" cssClass="aList">清除</s:a></td>
					</tr>
				</s:iterator>
				</tbody>
			</table>		
