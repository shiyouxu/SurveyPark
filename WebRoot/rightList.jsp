			...
			<s:form action="RightAction_batchUpdateRights" namespace="/" method="post">
				<table>
					<thead>
						...
						<tr>
							<!-- 输出分页条 -->
							<td colspan="10" style="height: 5px;text-align: left;"></td>
						</tr>
						<tr>
					...
					<tbody>
						<s:iterator value="allRights" status="st">
							...
							<tr>
								<td>
									<s:textfield name="allRights[%{#st.index].id" cssClass="text" readonly="true"/>
								</td>
								<td>
									<s:textfield name="allRights[%{#st.index].rightName" cssClass="text"/>
								</td>
					...
					<tr>
						<td colspan="10" style="height: 5px"><s:submit cssClass="btn" value="提交"></s:submit></td>
					</tr>
				</table>
			</s:form>
		</s:else>
